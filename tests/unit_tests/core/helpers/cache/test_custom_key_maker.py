...
async def test_make_no_args():
    ...
    # Then
    assert sut == "hide::tests.unit_tests.core.helpers.cache.test_custom_key_maker.test"
...
async def test_make_with_args():
    ...
    # Then
    assert sut == "hide::tests.unit_tests.core.helpers.cache.test_custom_key_maker.test.a"
